...
class PacienteForm(tk.LabelFrame):
    ...
    #obtiene los valores de los campos del formulario para crear un nuevo paciente   
...
class VerIMC(tk.Toplevel):
    def __init__(self,parent):
        ...
        #Obtengo el paciente con los datos del formulario
        self.paciente = parent.obtenerPaciente() #Metodo de la vista padre que llama al metodo del formulario
        self.calcularIMC()
...
class PacientesView(tk.Tk):
    ...
    def setControlador(self, ctrl):
        ...
        self.form.showIMC(ctrl.verImcPaciente) #le pasa al metodo del formulario la funcion de verimcPaciente del controlado
